    ...
    <div className="container mx-auto px-4 relative z-10 text-center">
      <Reveal>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href={`https://api.whatsapp.com/send?phone=5573991002247&text=${encodeURIComponent("Quero transformar meu negócio com a BF Agência!")}`} className="bg-black text-white font-bold text-lg px-10 py-4 rounded-lg hover:scale-105 transition-transform shadow-xl">Falar no WhatsApp</a>
